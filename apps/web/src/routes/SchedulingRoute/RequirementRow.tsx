...
export function RequirementRow({
  ...
  return (
    <tr className="requirement-row">
      ...
      <td data-label="Inspector" className="requirement-row__inspector">{rule.default_inspector_name ?? 'None'}</td>
      <td className="requirement-row__status"><span className={!archived && active ? 'status-pill status-pill--open' : 'status-pill status-pill--cancelled'}>{status}</span></td>
      {canAdminister ? (
