 ...
 * visibilidad lo hace la política `RESTRICTIVE` de 0012 (design D2). Un supervisor no ve
 * el incidente de otro supervisor porque la política no se lo devuelve, no porque este
