...
The system SHALL present the next step within the record of the state the finding is currently in,
and SHALL open that state by default. The single exception SHALL be an opened corrective action
