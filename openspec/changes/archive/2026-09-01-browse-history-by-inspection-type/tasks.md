...
- [x] 3.2 Ejecutar pruebas específicas, lint, build y typecheck en el orden requerido por el repositorio.
...
- [x] 4.7 Ejecutar lint, pruebas, validación OpenSpec, build y typecheck.
