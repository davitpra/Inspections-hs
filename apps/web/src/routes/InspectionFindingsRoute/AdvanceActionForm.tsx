...
import { stepForm } from './presentation';
 ...
 *
 * **QUÉ SE MUESTRA EN CADA ETAPA LO DECIDE `stepForm`, no este archivo.** Acá estaba escrito
 * como tres predicados sueltos sobre la lista de transiciones —uno de ellos con un estado
 * literal adentro—, y con eso no había dónde leer "en Verification se pide una razón y hay
 * dos salidas": la respuesta solo existía dibujada. Ahora la decisión tiene nombre, se prueba
 * sin renderizar y este componente la lee.
 *
 ...
 * rechazó —la regla del verificador (ADR-019) se comprueba allá, y su error se lee acá—.
 *
...
export function AdvanceActionForm({
  ...
  return (
    <div className="finding__step-fields">
      {form.evidence ? <EvidencePicker files={files} onChange={setFiles} /> : null}
